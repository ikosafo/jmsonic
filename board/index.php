                        ...
                        <div class="kt-widget__top">
                            ...
                            <div class="kt-widget__content">
                                ...
                                <div class="kt-widget__subhead">
                                    ...
                                    <a href="#"><i class="flaticon2-calendar-3"></i><?php $roleid = $_SESSION['roleid'];
                                        $getrole = $mysqli->query("select * from roles where roleid = '$roleid'");
                                        $resrole = $getrole->fetch_assoc();
                                        echo $resrole['roletypes'];
                        ...
                        <div class="kt-widget__bottom">
                            ...
                            <div class="kt-widget__item">
                                <div class="kt-widget__details">
                                    <span class="kt-widget__title">Boards</span>
                                                        <span class="kt-widget__value"><span><i class="la la-dashboard"></i> </span>
                                                            <?php
                                                            $getquery = $mysqli->query("select * from `boards`");
                            ...
                            <div class="kt-widget__item">
                                <div class="kt-widget__details">
                                    <span class="kt-widget__title">Split Boards</span>
                                                        <span class="kt-widget__value"><span><i class="la la-dashboard"></i> </span>
                                                            <?php
                                                            $getquery = $mysqli->query("select * from `boardsplits`");
                                                            echo mysqli_num_rows($getquery);
                                                            ?>
                                                        </span>
                                </div>
                                ...
                                <div class="kt-widget__details">
                                    <span class="kt-widget__title">Users</span>
                                                        <span class="kt-widget__value"><span><i class="la la-users"></i> </span>
                                                            <?php
                                                            $getquery = $mysqli->query("select * from `users`");
                                                            echo mysqli_num_rows($getquery);
                                                            ?>
                                                        </span>
                                </div>
                            ...
                            <div class="kt-widget__item">
                                <div class="kt-widget__details">
                                    <span class="kt-widget__title">Active Users</span>
                                                        <span class="kt-widget__value"><span><i class="la la-users"></i> </span>
                                                            <?php
                                                            $getquery = $mysqli->query("select * from `users` where userstatus = '4'");
                                                            echo mysqli_num_rows($getquery);
                                                            ?>
                                                        </span>
                                </div>
