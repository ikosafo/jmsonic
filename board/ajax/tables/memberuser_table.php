...
$query = $mysqli->query("select DISTINCT(boardid) as boardids from previewboard where userid = '$user_id'");
...
<!--begin: Datatable-->
<table class="table table-separate table-head-custom table-checkable" id="memberusertable">
    <thead>
    <tr>
        <th>Board Name</th>
