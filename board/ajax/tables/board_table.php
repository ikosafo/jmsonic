        ...
        <div class="kt-searchbar">
            <div class="input-group">
                ...
                <input type="text" id="board_search" class="form-control"
                       placeholder="Search Board" aria-describedby="basic-addon1">
            </div>
        </div>

        <div class="table-responsive">
            <table id="board-table" class="table" style="margin-top: 3% !important">
                <thead>
                <tr>
                    <th>Board Name</th>
                    <th>Date Created</th>
