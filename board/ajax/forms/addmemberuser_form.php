    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select id="selectboard" style="width: 100%">
                ...
                <?php
                $selectboard = $mysqli->query("SELECT * FROM boards b JOIN previewboard p ON b.`boardid` = p.`boardid` 
                WHERE p.`userid` = '$user_id' GROUP BY p.boardid");
...
<script>
        $("#selectboard").change(function () {
            ...
            if (getboard != "") {
                $.ajax({
                    url: "ajax/forms/getusercolour.php",
        ...
        $("#selectboard").change(function () {
            ...
            if (getboard != "") {
                $.ajax({
                    url: "ajax/forms/getaddusermember.php",
                    data: {getboard: getboard,
                            user_id:user_id
                           },
                    type: 'POST',
    ...
    $("#savemember").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/saveform_usermember.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
