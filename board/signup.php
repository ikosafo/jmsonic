                                                            ...
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="tel" class="form-control form-control-solid form-control-lg"
                                                                           name="phone" id="phone" placeholder="Telephone" value="" />
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control form-control-solid form-control-lg"
                                                                           name="nextofkin" id="nextofkin" placeholder="Next of Kin" value="" />
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="password" class="form-control form-control-solid form-control-lg"
                                                                           name="confirmpassword" id="confirmpassword" placeholder="Confirm Password" value="" />
