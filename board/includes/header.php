...
<head>
    ...
    <link href="assets/css/sweetalert/sweetalert.css" rel="stylesheet" type="text/css"/>
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="/">
            <img alt="Logo" src="assets/images/logo.png" style="width: 30%"/>
        </a>
    </div>
                            ...
                            <ul class="kt-menu__nav ">
                                ...
                                $_SERVER['PHP_SELF'] == "/board/splitconfig.php"
                                    ...
                                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                        <span class="kt-menu__link-text">Configurations
                                        ...
                                        <ul class="kt-menu__subnav">
                                            ...
                                            $_SERVER['PHP_SELF'] == "/board/boardconfig.php"
                                                ? "kt-menu__item--active" : ""); ?>" aria-haspopup="true"><a
                                                    ...
                                                    class="kt-menu__link "><i
                                                        ...
                                                        <span></span></i><span
                                                        class="kt-menu__link-text">Board</span></a>
                                            </li>
                                            ...
                                            $_SERVER['PHP_SELF'] == "/board/colourconfig.php"
                                                ? "kt-menu__item--active" : ""); ?>" aria-haspopup="true"><a
                                                    ...
                                                    class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot">
                                                        <span></span></i><span
                                                        class="kt-menu__link-text">Colour</span></a>
                                            </li>
                                            ...
                                            $_SERVER['PHP_SELF'] == "/board/paymentconfig.php"
                                                ? "kt-menu__item--active" : ""); ?>" aria-haspopup="true"><a
                                                    ...
                                                    class="kt-menu__link "><i
                                                        ...
                                                        class="kt-menu__link-text">Payment</span></a>
                                            </li>
                                            ...
                                            $_SERVER['PHP_SELF'] == "/board/splitconfig.php"
                                                ? "kt-menu__item--active" : ""); ?>" aria-haspopup="true"><a
                                                    ...
                                                    class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">Split</span></a>
                                            </li>
                                ...
                                $_SERVER['PHP_SELF'] == "/board/useraccounts.php"
                                    ...
                                    data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                        <span class="kt-menu__link-text">Boards
                                            <i class="fa fa-caret-down ml-2"></i> </span>
                                        <i class="kt-menu__ver-arrow la la-angle-right"></i>
                                    </a>
                                ...
                                $_SERVER['PHP_SELF'] == "/useraccounts.php"
                                    ...
                                    data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                        <span class="kt-menu__link-text">Members
                                            <i class="fa fa-caret-down ml-2"></i> </span>
                                        <i class="kt-menu__ver-arrow la la-angle-right"></i>
                                    </a>
                                        ...
                                        <ul class="kt-menu__subnav">
                                            ...
                                            $_SERVER['PHP_SELF'] == "/applicantfiles.php"
                                                ? "kt-menu__item--active" : ""); ?>" aria-haspopup="true"><a
                                                    ...
                                                    class="kt-menu__link "><i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                                        class="kt-menu__link-text">Board Users</span></a>
                                            </li>
