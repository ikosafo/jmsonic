                    ...
                    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-1">
                            ...
                            <div class="d-flex flex-column">
                                <!--begin::Title-->
                                <h2 class="text-white font-weight-bold my-2 mr-5">Payments</h2>
                                <!--end::Title-->
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="card card-custom gutter-b example example-compact">
                                    <div class="card-header">
                                        <h3 class="card-title">Add / Update Payment</h3>
                                    </div>
                                    <!--begin::Form-->
                                    ...
                                    <div class="card-header flex-wrap py-3">
                                        <div class="card-title">
                                            <h3 class="card-label">Payment
                                                <span class="d-block text-muted pt-2 font-size-sm">View &amp; Delete Payments</span></h3>
                                        </div>
