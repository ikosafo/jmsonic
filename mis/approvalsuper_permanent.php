                                ...
                                <form class="">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="kt-radio-inline">
                                                <label class="kt-radio">
                                                    <input type="radio" name="form_submitted" value="Yes" <?php if (@$result['permanent_form_submitted'] == "Yes") echo "checked" ?>> Yes
                                                    <span></span>
                                                </label>
                                                <label class="kt-radio">
                                                    <input type="radio" name="form_submitted" value="No" <?php if (@$result['permanent_form_submitted'] == "No") echo "checked" ?>> No
                                                    <span></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="kt-radio-inline">
                                                <label class="kt-radio">
                                                    <input type="radio" name="approve_state" value="Approved" <?php if (@$result['permanent_admincheck_status'] == "Approved") echo "checked" ?>> Approve
                                                    <span></span>
                                                </label>
                                                <label class="kt-radio">
                                                    <input type="radio" name="approve_state" value="Rejected" <?php if (@$result['permanent_admincheck_status'] == "Rejected") echo "checked" ?>> Reject
                                                    <span></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group form-group-last">
                                            ...
                                            <textarea class="form-control" id="remark" rows="3"
                                                      placeholder="Enter Remark or Comment"><?php echo $result['permanent_admincheck_comment'] ?></textarea>
                                        </div>
                                    ...
                                    <div class="kt-portlet__body">
                                        <table class="table table-bordered">
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($result['permanent_payment'] == "0") { ?>
                                                        <button class="btn btn-sm btn-danger btn-floating">Not Paid</button>
                                                    <?php } else if ($result['permanent_payment'] == "1") { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $result['permanent_form_submitted'] ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Approved</td>
                                                <td>
                                                    <?php echo $result['permanent_usercheck_status'] ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Approved Remark</td>
                                                <td>
                                                    <?php echo $result['permanent_usercheck_comment'] ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Approved By</td>
                                                <td><?php $u_id = $result['permanent_usercheck_user'] ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $result['permanent_admincheck_status'] ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Final Approval Remark</td>
                                                <td>
                                                    <?php echo $result['permanent_admincheck_comment'] ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Final Approved By</td>
                                                <td><?php $u_id = $result['permanent_admincheck_user'] ?>
                                                    <?php $q = $mysqli->query("select * from mis_users where user_id = '$u_id'");
                                                    $r = $q->fetch_assoc();
                                                    echo $r['full_name'];
                                                    ?>
                                ...
                                <div class="invoice-header">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8" align="center">
                                            ...
                                            <hr/>
                                            PERMANENT REGISTRATION APPLICATION FORM
                                        </div>
                                        <div class="col-md-2" align="center">
...
<script>
    $("#saveapprovalbtn").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/superapproval_permanent.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
