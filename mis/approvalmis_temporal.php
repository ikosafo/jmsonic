                                ...
                                <form class="">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="kt-radio-inline">
                                                <label class="kt-radio">
                                                    <input type="radio" name="approve_state" value="Approved" <?php if (@$result['temporal_usercheck_status'] == "Approved") echo "checked" ?>> Approve
                                                    <span></span>
                                                </label>
                                                <label class="kt-radio">
                                                    <input type="radio" name="approve_state" value="Rejected" <?php if (@$result['temporal_usercheck_status'] == "Rejected") echo "checked" ?>> Reject
                                                    <span></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group form-group-last">
                                            ...
                                            <textarea class="form-control" id="remark" rows="3"
                                                      placeholder="Enter Remark or Comment"><?php echo $result['temporal_usercheck_comment'] ?></textarea>
                                        </div>
...
<script>
    ...
    $("#saveapprovalbtn").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/misapproval_temporal.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
