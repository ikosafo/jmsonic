                                ...
                                <form class="">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="kt-radio-inline">
                                                <label class="kt-radio">
                                                    <input type="radio" name="approve_state" value="Approved" <?php if (@$resdetails['exam_admincheck_status'] == "Approved") echo "checked" ?>> Approve
                                                    <span></span>
                                                </label>
                                                <label class="kt-radio">
                                                    <input type="radio" name="approve_state" value="Rejected" <?php if (@$resdetails['exam_admincheck_status'] == "Rejected") echo "checked" ?>> Reject
                                                    <span></span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="form-group form-group-last">
                                            ...
                                            <textarea class="form-control" id="remark" rows="3"
                                                      placeholder="Enter Remark or Comment"><?php echo $resdetails['exam_admincheck_comment'] ?></textarea>
                                        </div>
...
<script>
    ...
    $("#saveapprovalbtn").click(function () {
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/queries/superapproval_examination.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                success: function (text) {
                    ...
                    if (text == 2) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "approvalsuper_examination.php",
                            data: {
