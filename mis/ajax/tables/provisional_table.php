...
<script>
    ...
    if (admintype == 'Super Admin') {
        oTable = $('#prov-table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': 'ajax/paginations/provisional_super.php?year=<?php echo $year_search ?>&status=<?php echo $provisional_status ?>'
            },
            'columns': [
                {data: 'provisionalid'},
                {data: 'email_address'},
        ...
        oTable = $('#prov-table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': 'ajax/paginations/provisional_mis.php?year=<?php echo $year_search ?>&status=<?php echo $provisional_status ?>'
            },
            'columns': [
                {data: 'provisionalid'},
                {data: 'email_address'},
