        ...
        <div class="form-group row">
            <div class="col-lg-12 col-md-12">
                ...
                <input type="text" class="form-control" id="fullname"
                       placeholder="Enter Full Name" value="<?php echo $result['full_name']; ?>">
            </div>
        </div>
                ...
                while ($respermission = $getpermission->fetch_assoc()){
                    ...
                    <table class="table">
                        <tr>
                            ...
                            <td width="30%"><a href="#" class="remove_permission"
                                    p_index="<?php echo $respermission['id'] ?>"
                                    user_index="<?php echo $userindex ?>"
                                    i_index="<?php echo $theindex ?>">
                                    Remove
                                </a>
                            </td>
                        </tr>
        ...
        <div class="form-group row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="customRadioInline1" <?php if (@$result['approval'] == "Regular") echo "checked" ?>
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="customRadioInline2" <?php if (@$result['approval'] == "MIS Admin") echo "checked" ?>
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="customRadioInline3" <?php if (@$result['approval'] == "Super Admin") echo "checked" ?>
