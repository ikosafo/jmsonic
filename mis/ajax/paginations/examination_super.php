...
## Fetch records
            $empQuery = "select * from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id WHERE e.period_registered BETWEEN '$startdate' AND '$enddate' AND 1 ".$searchQuery."
...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id
            WHERE e.payment = '1'
            AND e.exam_usercheck_status = 'Approved' AND (e.exam_admincheck_status = '' OR e.exam_admincheck_status IS NULL)
...
## Total number of record with filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id
            WHERE e.payment = '1'
            AND e.exam_usercheck_status = 'Approved' AND (e.exam_admincheck_status = '' OR e.exam_admincheck_status IS NULL) AND
            e.period_registered BETWEEN '$startdate' AND '$enddate' AND 1 ".$searchQuery);
            $records = mysqli_fetch_assoc($sel);
            $totalRecordwithFilter = $records['allcount'];
...
## Fetch records
            ...
            AND e.exam_usercheck_status = 'Approved' AND (e.exam_admincheck_status = '' OR e.exam_admincheck_status IS NULL)
            AND 1 ".$searchQuery." ORDER BY e.period_registered DESC,e.payment DESC limit ".$row.",".$rowperpage;
            $empRecords = mysqli_query($con, $empQuery);
            $data = array();
...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id
                   where e.exam_type = 'Supplementary' AND e.period_registered BETWEEN '$startdate' AND '$enddate'");
            $records = mysqli_fetch_assoc($sel);
            $totalRecords = $records['allcount'];
...
## Fetch records
            $empQuery = "select * from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id WHERE
            e.exam_type = 'Supplementary' AND e.period_registered BETWEEN '$startdate' AND '$enddate' AND 1 ".$searchQuery."
            ORDER BY e.period_registered DESC,e.payment DESC limit ".$row.",".$rowperpage;
            $empRecords = mysqli_query($con, $empQuery);
            $data = array();
...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id
            WHERE  e.exam_type = 'Supplementary' AND e.payment = '1'
            AND e.exam_usercheck_status = 'Approved' AND (e.exam_admincheck_status = '' OR e.exam_admincheck_status IS NULL)
            AND e.period_registered BETWEEN '$startdate' AND '$enddate'");
            $records = mysqli_fetch_assoc($sel);
            $totalRecords = $records['allcount'];
...
## Fetch records
            $empQuery = "select * from examination_reg e JOIN provisional p ON e.applicant_id = p.applicant_id
            WHERE e.exam_type = 'Supplementary' AND e.period_registered BETWEEN '$startdate' AND '$enddate' AND  e.payment = '1'
            AND e.exam_usercheck_status = 'Approved' AND (e.exam_admincheck_status = '' OR e.exam_admincheck_status IS NULL)
            AND 1 ".$searchQuery." ORDER BY e.period_registered DESC,e.payment DESC limit ".$row.",".$rowperpage;
            $empRecords = mysqli_query($con, $empQuery);
            $data = array();
...
## Fetch records
            ...
            ## Total number of record with filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg e JOIN provisional p 
