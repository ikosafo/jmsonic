            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                <div class="kt-portlet__body">
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <div class="kt-form__control">
                                        <select class="form-control bootstrap-select" id="permanent_status">
                            ...
                            <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <div class="kt-form__control">
                                        <select id="search_profession" style="width: 100%">
                                            <option value="Any">Any</option>
                                            <?php
                            ...
                            <div class="col-md-1 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <button type="button" id="search_permanent" class="btn btn-primary">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div id="permanent_table_div"></div>
                            </div>
                        </div>
...
<script>
    ...
    $("#search_permanent").click(function(){
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/tables/permanent_search_table.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                data: {
                    search_year: select_year,
                    search_region: search_region,
                    search_approval: permanent_status,
                    search_profession: search_profession
                },
                success: function (text) {
                    $('#permanent_table_div').html(text);
                },
