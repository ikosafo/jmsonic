...
<div class="kt-container  kt-grid__item kt-grid__item--fluid">
    ...
    <div class="row">
        <div class="col-xl-12">
            <!--begin:: Widgets/Applications/sms/Profile3-->
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="kt-portlet__head kt-portlet__head--lg mb-4">
                            <div class="kt-portlet__head-label">
                                <h3 class="kt-portlet__head-title">
                                    IT Management
                                    <small>Send Bulk SMS/Emails</small>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-5 col-xs-12 col-sm-12">
                                <div id="smsform_div"></div>
                            </div>
                            <div class="col-md-7 col-xs-12 col-sm-12">
                                <div id="smstable_div"></div>
                            </div>
                        </div>
            ...
            <!--end:: Widgets/Applications/sms/Profile3-->
        </div>
    </div>
