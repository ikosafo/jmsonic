                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <button type="button" id="search_temporal" class="btn btn-primary">
...
<script>
    ...
    $("#search_temporal").click(function(){
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/tables/temporal_search_table.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                data: {
                    ...
                    search_approval: temporal_status,
