                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <div class="kt-form__control">
                                        <select class="form-control bootstrap-select" id="renewal_status">
                            ...
                            <div class="col-md-1 kt-margin-b-20-tablet-and-mobile">
                                <div class="kt-form__group kt-form__group--inline">
                                    ...
                                    <button type="button" id="search_renewal" class="btn btn-primary">
...
<script>
    ...
    $("#search_renewal").click(function(){
        ...
        if (error == "") {
            $.ajax({
                type: "POST",
                url: "ajax/tables/renewal_search_table.php",
                beforeSend: function () {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
                ...
                data: {
                    ...
                    search_approval: renewal_status,
                    search_profession: search_profession
                },
                success: function (text) {
                    $('#renewal_table_div').html(text);
                },
