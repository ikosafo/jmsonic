            ...
            <div class="kt-grid__item  kt-grid__item--order-tablet-and-mobile-2  kt-grid kt-grid--hor kt-login__aside">
                <div class="kt-login__wrapper">
                    <div class="kt-login__container">
                        <div class="kt-login__body">
                            <div class="kt-login__logo">
                                <a href="#">
                                    <img src="newassets/img/ahpc_logo.png" style="width:20%;">
                                </a>
                            </div>

                            <div class="kt-login__signin">
                                <div class="kt-login__head">
                                    <h3 class="kt-login__title">Sign In To MIS Portal</h3>
                                </div>
                    ...
                    <span class="kt-login__account-msg">
                        For Accounts | Education & Training and Examination
                    </span>&nbsp;&nbsp;
                        <a href="https://admins.ahpcgh.org/" class="kt-login__account-link">Please
                            Click!</a>
                    </div>
                </div>
            </div>
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content"
                ...
                <div class="kt-login__section">
                    <div class="kt-login__block">
                        <h3 class="kt-login__title">Administrative panel for MIS</h3>
