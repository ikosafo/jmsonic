                ...
                <div class="kt-portlet__body">
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group row">
                            <label class="col-form-label col-lg-3 col-sm-12">Select year for bills</label>
...
<script>
    ...
    $("#select_year").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "ajax/tables/bills_table.php",
            beforeSend: function () {
                KTApp.blockPage({
                    overlayColor: "#000000",
                    type: "v2",
